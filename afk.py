...
class AFKMod(loader.Module):
    ...
    strings = {"name": "AFK",
               "gone": "<b>×ºℜ𝔢𝔟𝔢𝔩º× is goin' AFK</b>",
               "back": "<b>×ºℜ𝔢𝔟𝔢𝔩º× is no longer AFK</b>",
               "afk": "<b>×ºℜ𝔢𝔟𝔢𝔩º× is AFK right now (since {} ago).</b>",
               "afk_reason": "<b>×ºℜ𝔢𝔟𝔢𝔩º× is AFK right now (since {} ago).\nReason:</b> <i>{}</i>"}
